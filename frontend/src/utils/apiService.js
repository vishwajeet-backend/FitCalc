...
export const calculateBodyFat = (data) => calculateAPI('bodyfat', data);
export const calculateNavyBodyFat = (data) => calculateAPI('navy-bodyfat', data);
export const calculateArmyBodyFat = (data) => calculateAPI('army-bodyfat', data);
...
export const calculateCarbs = (data) => calculateAPI('carbs', data);
