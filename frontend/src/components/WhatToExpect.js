...
const WhatToExpect = () => {
  const expectations = [
    ...
    },
    {
      ...
      description: "Anyone should be able to access simple calculation tools without needing expert knowledge. We've cut the complexity, removing jargon and technical barriers. Our calculators are designed with a clear interface and layout that makes it easy to get accurate results without prior fitness training. Whether you're new to fitness or an advanced user, our design ensures you can track your health metrics and receive immediate feedback with confidence."
    },
    {
      title: "All Calculators in One Place", 
      description: "Everything you need for fitness and health tracking: BMI, body fat percentage, calorie needs, pregnancy weight gain, and more. Use our comprehensive suite of calculators to understand your body metrics and track your progress. FitCalc brings together all the essential fitness calculations you need in one convenient platform, helping you make informed decisions about your health and wellness journey."
    },
    {
      title: "All Calculators in One Place",
      description: "Testing gathered for fitness and healthcare purposes: pregnancy tracking, body composition analysis, and goal setting. Use our guidance to understand BMI calculations, pregnancy milestones, and nutritional needs. FitCalc is built to help you identify your health status and fitness goals through key recommendations tailored to your metrics. Whether you're tracking workout progress or maintaining health records, FitCalc provides everything you need in one fitness guidance platform."
    }
  ];
  ...
  return (
    <section className="what-expect-section">
      <div className="what-expect-container">
        <h2 className="what-expect-title">What You Can Expect From Us</h2>
